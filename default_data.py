...
def add_data_paket():
    add = [('1', 'Jojga1', '5720000', '4', 'Pantai Timang, Tebing Breksi, Sunset di Candi Ijo, Candi Borobudur, The Lost World Castle, Merapi Park, Malioboro, Keraton Yogyakarta, Tamansari, De Walik Museum',
